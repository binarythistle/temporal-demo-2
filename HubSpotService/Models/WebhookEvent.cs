public class WebhookEvent
{
    ...
    /// <summary>
    /// The timestamp the record was created in this app (HubSpotService)
    /// </summary>
    public DateTime CreatedAt { get; set; }

    /// <summary>
    /// The timestamp the webhook event was sent from the source system (Marketplacer)
    /// </summary>
    public DateTime SentFromSourceAt { get; set; }
}